    ...
    $.fn.ical = function(options){
        ...
        */
        function createNavigation(obj, insdate){
            obj.append("<div class='cal_head'><span id ='icalprev'><img src='http://static.allsaintscollege.org/images/arrow_left.png'></span> <span id = 'currentmonth'>"+ options.monthnames[insdate.getMonth()] +"</span> <span id = 'currentyear'>"+ insdate.getFullYear() +"</span> <span id ='icalnext'><img src='http://static.allsaintscollege.org/images/arrow_right.png'></span></div>");
